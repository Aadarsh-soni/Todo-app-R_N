...
const index = () => {
  ...
  const addTodo = async () => {
    try {
      ...
      axios
        .post("http://192.168.1.4:3000/todos/6583eea7c5bc35503ef0f5ae", todoData)
        .then((response) => {
  ...
  const getUserTodos = async () => {
    try {
      const response = await axios.get(
        `http://192.168.1.4:3000/users/6583eea7c5bc35503ef0f5ae/todos`
      );
  ...
  const markTodoAsCompleted = async (todoId) => {
    try {
      ...
      const response = await axios.patch(
        `http://192.168.1.4:3000/todos/${todoId}/complete`
      );
